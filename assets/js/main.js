document.addEventListener("DOMContentLoaded", function () {
    ...
    const totalSlides = 5;
    const linksUrls = [
        "https://www.youtube.com/playlist?list=PLaTrkuxDsNd2ygMlc72QkSJO7yKoq5i5K",
        "https://www.youtube.com/playlist?list=PLaTrkuxDsNd2ygMlc72QkSJO7yKoq5i5K",
        "https://www.youtube.com/playlist?list=PLaTrkuxDsNd2ygMlc72QkSJO7yKoq5i5K",
        "https://www.youtube.com/playlist?list=PLaTrkuxDsNd2ygMlc72QkSJO7yKoq5i5K",
        "https://www.youtube.com/playlist?list=PLaTrkuxDsNd2ygMlc72QkSJO7yKoq5i5K"
    ...
    function updateIndicators(index) {
        const nornalizedIndex = normalizeSlideTitle(index);
        ...
        gsap.to(indicators[nornalizedIndex - 1], {
            scaleX: 1,
            duration: 2,
            ease: "power4.inOut"
        });
    ...
    function updateLink(index) {
        const nornalizedIndex = normalizeSlideTitle(index) - 1;
        const linkElement = document.querySelector(".link-wrapper a");
        linkElement.href = linksUrls[nornalizedIndex];
    };
